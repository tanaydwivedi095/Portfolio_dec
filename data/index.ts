...
export const gridItems = [
  {
    id: 1,
    title: "I prioritize client collaboration, fostering open communication CHANGED",
    description: "",
...
export const projects = [
  {
    id: 1,
    title: "Nutrition RAG",
    des: "Fine Tuned LLM from scratch, able to generate answers based on nutrition.",
    img: "/rag.png",
